import { createBaseBlockConfig, createBlockHeader, createDifficultyIndicator, createThumbnailConfig, createStatsDisplay, createBlockActions, createLoadingState, createErrorState, } from './BaseBlock.js';
/**
...
export class LevelPreviewBlock {
     ...
     */
    static createLevelStats(levelData) {
        const stats = [
            {
                label: 'Plays',
    ...
    static createEnhancedBlockConfig(config, options) {
        ...
        if (options?.showLastPlayed && 'lastPlayedAt' in levelData) {
            ...
            const lastPlayed = levelData.lastPlayedAt;
            if (lastPlayed) {
