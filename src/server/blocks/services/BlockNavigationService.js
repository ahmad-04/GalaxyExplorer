...
export class BlockNavigationService {
     ...
     */
    static async handleBlockAction(actionId, actionContext) {
        try {
     ...
     */
    static async processWebviewLaunch(config, contextKey) {
        try {
     ...
     */
    static validateActionContext(actionContext) {
     ...
     */
    static createActionContext(postId, blockType, actionId, actionData, userId) {
        return {
            postId,
            blockType,
            actionId,
     ...
     */
    static async handleFallbackNavigation(ui, fallback) {
        if (!fallback) {
