...
(function (AnalyticsEventType) {
    AnalyticsEventType["BLOCK_VIEW"] = "BLOCK_VIEW";
    AnalyticsEventType["BLOCK_INTERACTION"] = "BLOCK_INTERACTION";
    AnalyticsEventType["BLOCK_ACTION"] = "BLOCK_ACTION";
    AnalyticsEventType["BLOCK_ERROR"] = "BLOCK_ERROR";
    AnalyticsEventType["BLOCK_LOAD_TIME"] = "BLOCK_LOAD_TIME";
    AnalyticsEventType["WEBVIEW_TRANSITION"] = "WEBVIEW_TRANSITION";
...
export class BlockAnalyticsService {
     ...
     * Track block view
     */
    static async trackBlockView(blockId, blockType, userId, properties) {
     ...
     */
    static async trackBlockInteraction(blockId, blockType, interactionType, userId, properties) {
        await this.trackEvent({
     ...
     */
    static async trackBlockAction(blockId, blockType, actionId, userId, properties) {
        await this.trackEvent({
     ...
     */
    static async trackLoadTime(blockId, blockType, loadTimeMs, properties) {
        await this.trackEvent({
     ...
     */
    static async trackWebviewTransition(blockId, blockType, actionId, userId, properties) {
        await this.trackEvent({
     ...
     */
    static async getABTestVariant(testId, userId) {
        try {
     ...
     */
    static async trackABTestConversion(testId, variantId, userId, conversionType, properties) {
        try {
    ...
    static async getABTestResults(testId) {
        try {
            ...
            const winnerVariant = eligibleVariants.length > 0
                ? eligibleVariants.reduce((best, current) => current.conversionRate > best.conversionRate ? current : best)
                : undefined;
     ...
     */
    static async updateMetrics(event) {
        try {
...
BlockAnalyticsService.EVENTS_KEY = 'block:analytics:events';
BlockAnalyticsService.METRICS_KEY = 'block:analytics:metrics';
BlockAnalyticsService.ENGAGEMENT_KEY = 'block:analytics:engagement';
BlockAnalyticsService.AB_TESTS_KEY = 'block:analytics:ab-tests';
BlockAnalyticsService.DASHBOARDS_KEY = 'block:analytics:dashboards';
